...
Description:  This page contains the information about the author with picture. --%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="aboutme">
        ...
        <div class="row">
            ...
            <p id="para2">
                Passionate Programmer, Web Developer & Web Designer who successfully develop vary websites and has been responsible in key programming languages like: HTML, CSS, PHP, ASP.NET (C#) JavaScript (nodejs, expressjs, angularjs), MYSQL and NOSQL Database(Mongo).
