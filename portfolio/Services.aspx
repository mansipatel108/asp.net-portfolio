...
Description:  This page contains the details of services provided by author. --%>
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-6">
                            <div class="service-item">
                                <span class="image">
                                    <img src="../Assets/Images/sql.gif" class="img-circle" width="200" height="200">
                                </span>
                                <h4>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="service-item">
                                <span class="image">
                                    <img src="../Assets/Images/microsoft1.gif" class="img-circle" width="200" height="200">
                                </span>
                                <h4>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="service-item">
                                <span class="image">
                                    <img src="../Assets/Images/web.gif" class="img-circle" width="200" height="200">
                                </span>
                                <h4>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="service-item">
                                <span class="image">
                                    <img src="../Assets/Images/web1.gif" class="img-circle" width="200" height="200">
                                </span>
                                <h4>
